...
/**
 * Decorates the JMS {@link javax.jms.ConnectionFactory}
 * in order to ensure JMS session instances are reused if {@link CachingConfiguration#isEnabled()} is 'true' and the
...
public class JmsCachingConnectionFactory extends CachingConnectionFactory implements Stoppable, Disposable {
  ...
  public JmsCachingConnectionFactory(ConnectionFactory targetConnectionFactory, String username, String password, String clientId,
                                     CachingConfiguration config, JmsSupport jmsSupport) {
    super(targetConnectionFactory);

    checkArgument(config.appliesTo(targetConnectionFactory),
