...
public class JmsConstants {
  ...
  public static final Set JMS_PROPERTY_NAMES = unmodifiableSet(new HashSet(
                                                                           Arrays.asList(new String[] {JMS_CORRELATION_ID,
                                                                               JMS_DELIVERY_MODE, JMS_DELIVERY_MODE,
                                                                               JMS_DESTINATION, JMS_EXPIRATION, JMS_MESSAGE_ID,
                                                                               JMS_PRIORITY, JMS_REDELIVERED, JMS_REPLY_TO,
